...
$lang['db_unable_to_connect'] = 'Tidak dapat terhubung ke server database menggunakan pengaturan koneksi yang digunakan.';
$lang['db_unable_to_select'] = 'Tidak dapat memilih database yang anda maksud: %s';
$lang['db_unable_to_create'] = 'Tidak dapat membuat database yang anda maksud : %s';
$lang['db_invalid_query'] = 'Query yang anda kirimkan tidak valid.';
$lang['db_must_set_table'] = 'Anda harus menentukan tabel database untuk di gunakan pada Query anda.';
